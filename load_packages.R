...
pacman::p_load(BiocManager, remotes)
BiocManager::install("EBImage")
pacman::p_load(tidyverse, sf, terra, stars, rnaturalearth, rnaturalearthdata, mregions, tmap, leaflet, BiocManager, ggimage, gganimate, prioritizr)
